...
:titletext: OGC Tiling Conceptual Model and Logical Model for 2-D Planar Space
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Submission Date: 2019-MAY-01
|Approval Date:   <2019-mm-dd>
|Publication Date:   <2019-mm-dd>
|External identifier of this OGC(R) document: http://www.opengis.net/doc/AS/2d-tiles/1.0
|Internal reference number of this OGC(R) document:    19-014
|Version: 1.0
|Category: OGC(R)  Candidate Abstract Specification
...
include::clause_7_conceptual_model.adoc[]

include::clause_8_2d_logical_model.adoc[]
