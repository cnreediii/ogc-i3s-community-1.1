:Title: OGC Indexed 3d Scene Layer (I3S) and Scene Layer Package Format Community Standard 
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|External identifier of this OGC(R) document:  http://www.opengis.net/doc/CS/i3s/1.1
|Internal reference number of this OGC(R) document:    17-014r6
|Version: 1.1
